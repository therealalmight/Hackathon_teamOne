...
public class TravelInsurance extends Base{
	...
	By start = By.xpath("//button[@aria-label='May 21, 2022']");
	By end = By.xpath("//button[@aria-label='May 26, 2022']");
	By med = By.id("ped_no");
	...
	By low = By.xpath("/html/body/section/div/div[2]/ul/li[2]/div/div/div[2]/div[2]/label");
	...
	public void travel() throws InterruptedException {
		...
		wait(Duration.ofSeconds(20), mobile);
		driver.findElement(mobile).sendKeys("7280970352");
		wait(Duration.ofSeconds(20), proceed);
		Thread.sleep(3000);
		driver.findElement(proceed).click();
		Thread.sleep(5000);
		wait(Duration.ofSeconds(20), student);
